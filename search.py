...
if user_id: 
    ...
    query = st.chat_input("ask Optima", disabled=st.session_state.disabled, on_submit=disable, max_chars=50)
    ...
    st.markdown("<h3 style='text-align: center;'>Please read instructions in the sidebar carefully and \n type in your Prolific ID to initiate this service! \n You have a single opportunity to search with Optima. Ensure your query is under 50 characters.</h3>", unsafe_allow_html=True)
